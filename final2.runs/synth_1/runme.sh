...
HD_PWD='C:/Users/bkh18/ece350-newfinal/final2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stepper.tcl
