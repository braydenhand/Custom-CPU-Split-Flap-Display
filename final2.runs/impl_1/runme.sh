...
HD_PWD='C:/Users/bkh18/ece350-newfinal/final2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stepper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stepper.tcl -notrace
